    ...
    <div className="fade-in">
      ...
      {activeTab === 'inventory' ? (
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--color-border)', padding: '25px', borderRadius: '12px' }}>
          <h3 style={{ color: '#fff', margin: '0 0 15px 0', fontSize: '1.2rem' }}>📦 Smart Ingredient Stockroom (Read-Only)</h3>
          {inventoryLoading ? (
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--color-border)', padding: '25px', borderRadius: '12px' }}>
          <h3 style={{ color: '#fff', margin: '0 0 15px 0', fontSize: '1.2rem' }}>📋 Cafe Dishes & Ingredient Recipes (Read-Only)</h3>
          {menuLoading ? (
            <div style={{ textAlign: 'center', padding: '40px 0' }}>
              <div className="spinner" style={{ margin: '0 auto 10px auto', borderColor: 'var(--color-primary)' }} />
                  ...
                  <div className="admin-menu-info" style={{ padding: '15px', display: 'flex', flexDirection: 'column', height: '100%' }}>
                    <div style={{ flexGrow: 1 }}>
                      ...
                      <div style={{ fontSize: '12px', color: '#fff', marginBottom: '8px' }}>
                        ⏱️ Prep Time: <strong>{item.preparationTime || 10} minutes</strong>
                      </div>
        ...
        <div className="modal-overlay">
          <div className="modal-container">
            <div className="modal-header">
              <h3 className="modal-title">⚠️ Report Stock Shortage</h3>
