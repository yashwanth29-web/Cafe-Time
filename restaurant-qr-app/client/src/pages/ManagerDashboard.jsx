      ...
      {loading ? (
        ...
        <div>
          ...
          {activeTab === 'attendance' && (
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--color-border)', padding: '25px', borderRadius: '12px' }}>
              <h3 style={{ color: '#fff', margin: '0 0 15px 0', fontSize: '1.2rem' }}>👥 Employee Attendance Register</h3>
              {staffList.length === 0 ? (
          ...
          {activeTab === 'inventory' && (
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--color-border)', padding: '25px', borderRadius: '12px' }}>
              <h3 style={{ color: '#fff', margin: '0 0 15px 0', fontSize: '1.2rem', fontWeight: 800 }}>📦 Smart Ingredient Stockroom</h3>
                ...
                <div style={{ borderRight: '1px solid #5C4331', paddingRight: '30px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                      ...
                      <strong style={{ color: '#fff' }}>₹{todaySales.toFixed(2)}</strong>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                      <span style={{ color: 'var(--color-text-secondary)' }}>Total Ticket Orders:</span>
                      <strong style={{ color: '#fff' }}>{todayCompletedOrders.length} orders</strong>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                      ...
                      <strong style={{ color: '#fff' }}>30%</strong>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem' }}>
                      <span style={{ color: 'var(--color-text-secondary)' }}>Bakery & Desserts:</span>
                      <strong style={{ color: '#fff' }}>15%</strong>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'menu' && (
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--color-border)', padding: '25px', borderRadius: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <div>
                  <h3 style={{ fontSize: '1.2rem', color: '#fff', margin: 0, fontWeight: 800 }}>📋 Cafe Dishes & Availability</h3>
                    ...
                    <div key={item.id} className={`admin-menu-card ${!item.available ? 'unavailable' : ''}`} style={{
                      ...
                      <div className="admin-menu-info" style={{ padding: '15px', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        <div style={{ flexGrow: 1 }}>
                          ...
                          <h4 style={{ color: '#fff', margin: '8px 0 4px 0', fontSize: '1.05rem', fontWeight: 700 }}>{item.name}</h4>
                          <p style={{ fontSize: '12px', color: 'var(--color-text-secondary)', margin: '0 0 12px 0', minHeight: '36px' }}>{item.description}</p>
                          {item.recipe && item.recipe.length > 0 && (
                            <div style={{ fontSize: '11px', color: '#A0826C', marginBottom: '12px', background: 'rgba(255,255,255,0.02)', padding: '6px 10px', borderRadius: '6px', border: '1px dashed #5C4331' }}>
        ...
        <div className="modal-overlay">
          <div className="modal-container">
            <div className="modal-header">
              <h3 className="modal-title">✏️ Update Stock Quantity</h3>
      ...
      {showPriceModal && updatingItem && (
        <div className="modal-overlay">
          <div className="modal-container" style={{ maxWidth: '400px' }}>
            <div className="modal-header">
              <h3 className="modal-title">✏️ Update Dish Price</h3>
